/*************************************************** 
  This is a modified version of the buildtest program is part of the
  ...
  The following text is from the original buildtest program:
...
*/
  ...
  */
  ...
  uint32_t ipAddress = cc3000.IP2U32(192, 168, 1, 8);
