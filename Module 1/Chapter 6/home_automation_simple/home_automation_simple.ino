/***************************************************
  ...
  PACKT Publishing.
  Once the program has been uploaded, use a terminal such as Putty and load the
  IP address of the CC3000 which can be obtained from the serial monitor. Also
  switch to Telnet as the mode of communication.
  Commands:
  1 - Relay ON
  0 - Relay OFF
  q - Disconnect
